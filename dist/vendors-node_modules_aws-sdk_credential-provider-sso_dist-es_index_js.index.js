"use strict";
exports.id = "vendors-node_modules_aws-sdk_credential-provider-sso_dist-es_index_js";
exports.ids = ["vendors-node_modules_aws-sdk_credential-provider-sso_dist-es_index_js"];
exports.modules = {
...
/* harmony import */ var _isSsoProfile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./isSsoProfile */ "./node_modules/@aws-sdk/credential-provider-sso/dist-es/isSsoProfile.js");
/* harmony import */ var _resolveSSOCredentials__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resolveSSOCredentials */ "./node_modules/@aws-sdk/credential-provider-sso/dist-es/resolveSSOCredentials.js");
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types */ "./node_modules/@aws-sdk/credential-provider-sso/dist-es/types.js");
...
/* harmony export */ });
/* harmony import */ var _aws_sdk_token_providers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @aws-sdk/token-providers */ "./node_modules/@aws-sdk/token-providers/dist-es/fromSso.js");
/* harmony import */ var _smithy_property_provider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @smithy/property-provider */ "./node_modules/@smithy/property-provider/dist-es/index.js");
/* harmony import */ var _smithy_shared_ini_file_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @smithy/shared-ini-file-loader */ "./node_modules/@smithy/shared-ini-file-loader/dist-es/index.js");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, profile, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await __webpack_require__.e(/*! import() */ "vendors-node_modules_aws-sdk_credential-provider-sso_dist-es_loadSso_js").then(__webpack_require__.bind(__webpack_require__, /*! ./loadSso */ "./node_modules/@aws-sdk/credential-provider-sso/dist-es/loadSso.js"));
    const sso = ssoClient ||
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/*! import() */ "vendors-node_modules_aws-sdk_client-sso-oidc_dist-es_index_js").then(__webpack_require__.bind(__webpack_require__, /*! @aws-sdk/client-sso-oidc */ "./node_modules/@aws-sdk/client-sso-oidc/dist-es/index.js"));
...
const getSsoOidcClient = async (ssoRegion) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/*! import() */ "vendors-node_modules_aws-sdk_client-sso-oidc_dist-es_index_js").then(__webpack_require__.bind(__webpack_require__, /*! @aws-sdk/client-sso-oidc */ "./node_modules/@aws-sdk/client-sso-oidc/dist-es/index.js"));
